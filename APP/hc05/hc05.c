...
u8 HC05_Init(void)
{
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE); // ��1?��PORTA

    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15;        // ???��????
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;     // ��?��-��?��?
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; // IO?��?��?��?a50MHz
    GPIO_Init(GPIOA, &GPIO_InitStructure);            //?��?Y����?��2?��y3?��??��A15

    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4;         // ???��????
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;  // ��?������?3?
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; // IO?��?��?��?a50MHz
    GPIO_Init(GPIOA, &GPIO_InitStructure);            //?��?Y����?��2?��y3?��??��GPIOA4
